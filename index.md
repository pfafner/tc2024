...
12       | 21.08.2024   | Lema de Bombeo (*Pumping Lemma*) para lenguales regulares. [Aula 10](aulas/Aula10.pdf){:target="_blank"} | Hopcroft-Ullman, Sección 3.4 
...
**No.**  | **Fecha**    | **Tópicos**                                                     | **Recursos**
-------- | ------------ | --------------------------------------------------------------- |  ---------------------
1        | 23.10.2024   | Proyecto 3 - Máquinas de Turing.                                | [Proyecto 3](proyectos/Proyecto3.pdf){:target="_blank"} <br/> **Fecha de Entrega: domingo 24 de noviembre.**
